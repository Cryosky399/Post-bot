...
def satrni_havolaga_aylantir(satr: str) -> str:
    """
    Kirish: "Nomi | https://t.me/..." yoki "Nomi - https://..." yoki "Nomi https://..."
    Chiqish: HTML: <a href="https://...">Nomi</a>
    Agar URL topilmasa, bo'sh string qaytaradi.
    """
    satr = satr.strip()
    if not satr:
        return ""
...
def matnni_havolalarga_aylantir(matn: str) -> str:
    """Bir nechta qatorni qayta ishlaydi, faqat to'g'ri formatlanganlarini qaytaradi."""
    natija_qatorlar = []
